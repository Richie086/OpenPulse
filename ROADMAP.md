...
- [x] HTML5 / Vite static SPA foundation.
...
### 🟡 Phase 2: Enhanced Cloud & Audio Enhancements (v1.1.0) — *Target Q4 2026*
- [ ] **Subsonic / Navidrome API Sync**: Connect directly to hosted Subsonic/Navidrome servers to stream remote music libraries.
- [ ] **Crossfade & Gapless Playback**: Implement smooth 2-second crossfade transitions between queued tracks.
- [ ] **Custom Theme Builder UI**: Visual color pickers for custom CSS variable theme creation.
